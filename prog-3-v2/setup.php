...
<body>
    <div class="container">
        ...
        try {
            ...
            if ($row['count'] == 0) {
                // Insert sample items (price and cost_price set the same for initial data)
                $sql = "INSERT INTO `items` (item_name, price, cost_price, quantity, isles, shelf_position) VALUES
                    ('Sample Item 1', 29.99, 29.99, 50, 'Aisle 1', 'Shelf A-3'),
                    ('Sample Item 2', 15.50, 15.50, 100, 'Aisle 2', 'Shelf B-5'),
                    ('Sample Item 3', 45.00, 45.00, 25, 'Aisle 1', 'Shelf A-1')";
